    ...
    return (
        <div className="bg-white px-4 pt-3 pb-4 rounded-md border border-gray-200 flex-1">
            ...
            <div className="border-x border-gray-200 rounded-sm mt-3">
                <table className="w-full text-gray-700 border-separate border border-slate-400 border-spacing-4">
                    <thead className='bg-gray-100 border-collapse border border-slate-300'>
                        <tr>
                            <th>ID</th>
                            <th>Product ID</th>
                            <th>Customer Name</th>
                    ...
                    <tbody>
                        {recentOrderData.map((order) => (
                            <tr key={order.id} className=' border-collapse border border-slate-400 text-left'>
                                <td>
